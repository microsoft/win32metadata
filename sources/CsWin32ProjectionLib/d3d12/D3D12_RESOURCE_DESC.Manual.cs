...
using static Microsoft.Windows.Win32.D3D12_RESOURCE_FLAGS;
...
namespace Microsoft.Windows.Win32
{
    public unsafe partial struct D3D12_RESOURCE_DESC : IEquatable<D3D12_RESOURCE_DESC>
    {
        ...
        public static D3D12_RESOURCE_DESC Buffer(in D3D12_RESOURCE_ALLOCATION_INFO resAllocInfo, D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE)
        {
        ...
        public static bool operator ==(in D3D12_RESOURCE_DESC l, in D3D12_RESOURCE_DESC r)
        {
        ...
        {
            return $"{Dimension},{Alignment},{Width},{Height},{DepthOrArraySize},{MipLevels},{Format},{SampleDesc},{Layout},{Flags}".GetHashCode();
