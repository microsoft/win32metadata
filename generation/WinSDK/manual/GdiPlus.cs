...
namespace Windows.Win32.Graphics.GdiPlus
{
    ...
    public struct GpMetafile;
    public struct GpImageAttributes;
    public struct GpPath;
    public struct GpRegion;
    public struct GpPathIterator;
    public struct GpFontFamily;
    public struct GpFont;
    public struct GpStringFormat;
    public struct GpFontCollection;
    public struct GpInstalledFontCollection;
    public struct GpPrivateFontCollection;
