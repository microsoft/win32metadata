 ...
 *   Type can be activated via the Windows.Security.Credentials.IKeyCredentialCacheConfigurationFactory interface starting with version 20.0 of the Windows.Foundation.UniversalApiContract API contract
 *
 * Class implements the following interfaces:
 ...
 *   Static Methods exist on the Windows.Security.Credentials.IKeyCredentialManagerExtendedStatics interface starting with version 20.0 of the Windows.Foundation.UniversalApiContract API contract
