...
namespace Windows.Win32.Graphics.Direct3D12
{
    public static partial class Apis
    {
        ...
        public static readonly Guid D3D12_PROTECTED_RESOURCES_SESSION_HARDWARE_PROTECTED__scanned__ = new Guid(0x62B0084E, 0xC70E, 0x4DAA, 0xA1, 0x09, 0x30, 0xFF, 0x8D, 0x5A, 0x04, 0x82);

        public const uint D3D12_SHADING_RATE_X_AXIS_SHIFT = 2;

        public const uint D3D12_SHADING_RATE_VALID_MASK = 3;

        public static readonly Guid DXGI_DEBUG_D3D12__scanned__ = new Guid(0xcf59a98c, 0xa950, 0x4326, 0x91, 0xef, 0x9b, 0xba, 0xa1, 0x7b, 0xfd, 0x95);
