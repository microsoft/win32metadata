...
#define _SA_annotes0(n)                __attribute__((annotate(_SA_SPECSTRIZE(Name=n))))
#define _SA_annotes1(n,pp1)            __attribute__((annotate(_SA_SPECSTRIZE(Name=n; p1=pp1))))
#define _SA_annotes2(n,pp1,pp2)        __attribute__((annotate(_SA_SPECSTRIZE(Name=n; p1=pp1; p2=pp2))))
#define _SA_annotes3(n,pp1,pp2,pp3)    __attribute__((annotate(_SA_SPECSTRIZE(Name=n; p1=pp1; p2=pp2; p3=pp3))))
