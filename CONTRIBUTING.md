...
Note that when rebuilding the winmd with `./DoAll.ps1`, you may need to run a clean build with `./DoAll.ps1 -Clean` to avoid stale artifacts on your system conflicting with refactoring changes.