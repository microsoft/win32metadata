...
Run `./scripts/Install-AllSoftware.ps1 ` to install all of the aforementioned software. To use this script, make sure that the [Microsoft App Installer](https://www.microsoft.com/p/app-installer/9nblggh4nns1) is installed.
