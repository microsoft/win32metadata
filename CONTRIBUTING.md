...
* If test reports missing entries in emptyDelegatesAllowList.rsp, the scraper's auto-discovery heuristic in RemapDiscovery.cs should handle function pointer fixups automatically. If a new pattern is encountered that the heuristic doesn't cover, investigate adding a new discovery pass.
